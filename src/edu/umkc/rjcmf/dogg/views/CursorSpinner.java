...
import edu.umkc.rjcmf.dogg.adapters.SpinnerCursorAdapter;
...
public class CursorSpinner extends Spinner {
    ...
    public void filter(String selection, String[] selectionArgs) {
        // try running this on a background thread?
        Uri uri = Uri.withAppendedPath(PottyProvider.BASE_URI, mUriPath);
