...
public class DateButton extends Button {
	...
	private void showDialog() {
		mDialog = new StaticDatePickerDialog(getContext(), mDateSetCallback,
				mCalendar);
		mDialog.show();
	}
	...
	private static class StaticDatePickerDialog extends DatePickerDialog {
		...
		public StaticDatePickerDialog(Context context,
		...
		@Override
		public void onDateChanged(DatePicker picker, int year, int month,
				int day) {
